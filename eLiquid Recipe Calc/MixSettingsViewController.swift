...
class MixSettingsViewController: FormViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Submit", style: .Plain, target: self, action: #selector(MixSettingsViewController.submit(_:)))
    }
